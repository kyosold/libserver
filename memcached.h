...
enum transmit_result my_write(conn *c);
enum store_item_type set_cache(conn *c, char *key, size_t nkey, unsigned int flags, time_t exptime, char *val, size_t nval);
char *get_cache(conn *c, char *key, size_t nkey);
